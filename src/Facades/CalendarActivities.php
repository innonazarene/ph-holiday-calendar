 ...
 * @method static \Illuminate\Support\Collection activities(int $year = 0, int $month = 0)
 * @method static array forMonth(int $year = 0, int $month = 0)
 * @method static array forYear(int $year = 0)
